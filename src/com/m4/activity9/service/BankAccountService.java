...
public class BankAccountService {
	...
	public void createAccount(String accountNumber, String ownerName, double initialBalance)
		...
		if (initialBalance < MINIMUM_INITIAL_BALANCE) {
			...
			logger.warn("Account creation failed: invalid initial balance {}", String.format("%.2f", initialBalance));
			...
			throw new InvalidAccountException(String.format("Account creation failed: initial balance: %.2f, minimum initial balance required: %.2f", initialBalance, MINIMUM_INITIAL_BALANCE));
		...
		try {
			...
			throw new InvalidAccountException("Account creation failed " + e.getMessage(), e);
